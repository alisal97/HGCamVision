...
//  HGCam
//
//  Created by Aly Salman on 05/07/23.
...
class VisionViewController: UIViewController {
    ...
    private var finishedSaving = true
    ...
    func startRecording() {
        if !movieOutput.isRecording {
            ...
            startTimer()
            VisionViewController.isRecording = true
...
extension VisionViewController: AVCapturePhotoCaptureDelegate {
...
extension VisionViewController: AVCaptureFileOutputRecordingDelegate {
    ...
    func fileOutput(_ output: AVCaptureFileOutput, didFinishRecordingTo outputFileURL: URL, from connections: [AVCaptureConnection], error: Error?) {
        ...
        videoQueue.async { // adding to queue for piortizing and to proof from interruptions
            ...
            guard let exportSession = AVAssetExportSession(asset: asset, presetName: AVAssetExportPresetHighestQuality) else {
                ...
                VisionViewController.isRecording = false
